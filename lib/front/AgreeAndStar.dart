...
text1() {
  return Padding(
    ...
    child: Center(
      child: Text(
        "Welcome to Barta", style: TextStyle(fontSize: 25,
      ...
      child: RichText(
        text: TextSpan(
            ...
            children: [
              ...
              TextSpan(text: " accept the Terms of Service . . .", style: TextStyle(color: Colors.blueGrey, fontWeight:FontWeight.bold)
              ),
            ]
        ),
      ),
